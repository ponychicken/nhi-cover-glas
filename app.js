...
var mapRange = function mapRange(from, to, s) {
...
function setup(container) {
  ...
  container.addEventListener("pointermove", function (e) {
    ...
    if (dragging) {
      var x = (point.x - offset.x) * dragging.dragSpeed + dragging.lastPoint.x;
      var y = (point.y - offset.y) * dragging.dragSpeed + dragging.lastPoint.y;
...
},{"./lib/PointerProxy":6,"points":3,"whatwg-fetch":4}],2:[function(require,module,exports){
/*!
 * EventEmitter2
